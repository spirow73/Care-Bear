            ...
            >
                <div class="p-4 border-b dark:border-gray-600 flex justify-between items-center">
                    <a href={`/journal/${journal.journal_id}`} class="block">
                        <div>
                            <h1 class="text-2xl font-semibold text-gray-800 dark:text-gray-200">{journal.title}</h1>
                            <p class="text-sm text-gray-600 dark:text-gray-300">{journal.description}</p>
                            <p class="text-sm text-gray-500 dark:text-gray-400">Journal ID: {journal.journal_id}</p>
                        </div>
                    </a>
                    <button
