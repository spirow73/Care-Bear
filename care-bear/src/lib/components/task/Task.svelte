    ...
    <div class="flex items-center flex-1">
        ...
        >
            ...
            <div class="flex items-center">
                <span
                    class="{isCompleted ? 'bg-green-500' : 'bg-red-500'} h-6 w-6 rounded-full flex items-center justify-center mr-2"
                    role="checkbox"
        ...
        <div class="flex ml-4">
            ...
            {:else}
                <div class="flex">
                    ...
                    <button on:click={toggleEdit} class="ml-2 focus:outline-none" aria-label="{isEditing ? 'Cancel Edit' : 'Edit Task'}" title="{isEditing ? 'Cancel Edit' : 'Edit Task'}">
                        {isEditing ? '❌' : '🖊️'}
                    </button>
                </div>
            {/if}
        ...
        <span class="px-1 py-1 text-xs font-semibold rounded-lg uppercase {isCompleted ? 'bg-green-200 text-green-800' : 'bg-red-200 text-red-800'}">
