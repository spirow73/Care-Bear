...
<div class={`min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 ${darkModeClass}`}>
    <div class="max-w-2xl w-full space-y-8 border border-gray-300 rounded-lg p-6 bg-brown-900 dark:bg-gray-800">
		<div>
			<!-- Calendar Header -->
